...
![A diagram showing how to read a contract on Etherscan. ](../Images/5341af05a112e57342b5d65a8f592daa.png)

这将把您带到可以与合同进行交互的页面。如果您转到 characters 部分，您可以输入我们刚刚生成的 tokenId，并查看您的新 D&D 角色的统计数据！

![A diagram showing smart contract variables in Etherscan. ](../Images/8bc9936a505542f5cf2cf49ffbdc9528.png)
