...
![Calculating if the SmartZip Automated Valuation Model valuation is greater than the average for the given ZIP code for the given square footage](../Images/eaaf2e002cdd91e16ebe82ccdcebadce.png)
...
![Obtaining the average property valuation based on the two different pricing valuation models](../Images/377ca096d4f74a15e7e251d9818d88cf.png)
